...
export default function ServiceAreas() {
  return (
    <section id="service-areas" className="border-t border-gray-100 bg-[#F8FAF8] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <p className="text-sm font-bold uppercase tracking-widest text-green-600">Service Areas</p>
        ...
        <div className="mx-auto mt-10 max-w-5xl rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_20px_35px_-26px_rgba(15,23,42,0.65)]">
          <div className="grid items-center gap-6 md:grid-cols-[1.1fr_0.9fr]">
            <div>
              <h3 className="text-lg font-semibold text-[#111827]">Local Coverage You Can Trust</h3>
            ...
            <div className="rounded-2xl border border-green-100 bg-gradient-to-br from-green-50 via-white to-white p-4">
              ...
              <div className="mt-4 h-24 rounded-xl border border-green-100 bg-[radial-gradient(circle_at_20%_40%,rgba(46,125,50,0.22),transparent_30%),radial-gradient(circle_at_70%_70%,rgba(76,175,80,0.18),transparent_35%)]" />
            </div>
          </div>
        </div>
      </div>
